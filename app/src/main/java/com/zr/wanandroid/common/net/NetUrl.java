...
public class NetUrl {
    ...
    /*首页文章列表*/
    public static final String HOME_ARTICLE_LIST=NetHost.API_HOST+"article/list/";
    ...
    /*热门搜索词,k ： 搜索关键词*/
    public static final String HOME_SEARCH_ARTICLE=NetHost.API_HOST+"article/query/";
}
