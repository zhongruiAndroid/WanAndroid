...
public class QuestionPresenter extends BasePresenter<QuestionFragment> implements LoadMoreAdapter.OnLoadMoreListener {
    ...
    public void getData(int page, boolean isLoad) {
        QuestionModel.getInstance().getQuestionList(page, new BaseRequestListener<List<HomeArticleBean>, Boolean>() {
            @Override
