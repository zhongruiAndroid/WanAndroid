...
public class TestBgSpanActivity extends BaseActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    public void initView() {
        ...
        borderColor = findViewById(R.id.borderColor, true);
        ...
        bgColor = findViewById(R.id.bgColor, true);
        textColor = findViewById(R.id.textColor, true);
